...
import com.jlndev.movies.core.util.Constants.MOVIE_DETAIL_ARGUMENT_KEY
...
sealed class BottomNavItem(val title: String, val icon: ImageVector, val route: String) {
    ...
    object MovieSeach : BottomNavItem(
        title = "Pesquisar",
    ...
    object MovieDetail : BottomNavItem(
        ...
        route = "movie_detail_screen?$MOVIE_DETAIL_ARGUMENT_KEY=" +
                "{$MOVIE_DETAIL_ARGUMENT_KEY}"
    ){
        fun passMovieId(movieId: Int) =
            "movie_detail_screen?$MOVIE_DETAIL_ARGUMENT_KEY=$movieId"
    }
}
